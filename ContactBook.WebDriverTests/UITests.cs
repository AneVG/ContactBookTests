...
namespace ContactBook.WebDriverTests
{
    public class UITests
    {
        ...
        [Test]
        public void Test_CheckListFirstContact()
        {
        ...
        [Test]
        public void Test_SearchContact_EmptyResult()
        {
            //Arrange
            driver.Navigate().GoToUrl(url);
            driver.FindElement(By.LinkText("Search")).Click();
        ...
        [Test]
        public void Test_CreateContacts_InvalidDate()
        {
            //Arrange
            driver.Navigate().GoToUrl(url);
        ...
        public void Test_CreateContacts_ValidData()
        {
            ...
            var email = DateTime.Now.Ticks + "ani@abv.bg";
            var phone = "12345";
